...
class NewsApiClient(object):
    ...
    def __init__(self, api_key, api_url='http://newsapi.org/v2/'):
        self.url = api_url.rstrip('/')
        self.auth = NewsApiAuth(api_key=api_key)

    def get_top_headlines(self, q=None, sources=None, language='en', country='us', category=None, page_size=None,
                          page=None):
        """
    ...
    def get_sources(self, category=None, language=None, country='us'):
